...
# Maintained by Abhishek Chougule (Techbird).
#
...
show_help() {
  cat <<'HELP'
server-hardening.sh  (maintained by Abhishek Chougule, Techbird)
...
BANNER
  ...
  printf '%b  maintained by Abhishek Chougule (Techbird)%b\n\n' "$C_GREEN" "$C_RESET"
}
